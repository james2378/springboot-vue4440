<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0 0 0 0px","margin":"0","position":"relative","background":"#f1f2f7","display":"block"} : {"minHeight":"100%","padding":"125px 0 0 215px","margin":"0","position":"inherit","background":"#f7f7f7","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"padding":"0 20px 0 20px","margin":"0","borderColor":"#5daced","alignItems":"center","color":"#fff","display":"flex","justifyContent":"flex-end","top":"0","left":"0","background":"linear-gradient(to bottom, #208ed3 0%,#0272bd 100%)","borderWidth":"0 0 1px","width":"calc(100% - 0px)","fontSize":"14px","position":"fixed","borderStyle":"solid","zIndex":"1000","height":"60px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"0 30px","margin":"0px 0 0 0","borderColor":"#2a2a2a","display":"block","right":"0","top":"60px","borderWidth":"0 0 1px","background":"#3B3E40","width":"calc(100% - 215px)","fontSize":"13px","position":"fixed","borderStyle":"solid","height":"65px","zIndex":"1001"}' class="bread-crumbs"></bread-crumbs>
